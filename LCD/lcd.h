...
#define LCD_1IN47_CS_0	LCD_CS_CLR	 
#define LCD_1IN47_CS_1	LCD_CS_SET
	                 
#define LCD_1IN47_RST_0	LCD_RST_CLR
#define LCD_1IN47_RST_1	LCD_RST_SET	
	                  
#define LCD_1IN47_DC_0	LCD_DC_CLR
#define LCD_1IN47_DC_1	LCD_DC_SET
 ...
 * SPI
**/
#define DEV_SPI_WRITE(_dat)  SPI1_Write(_dat)
...
#define DEV_Set_PWM(_Value)     _Value: LCD_LED_SET?LCD_LED_CLR
